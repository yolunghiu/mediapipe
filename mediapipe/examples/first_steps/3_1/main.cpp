...
/// Here we use SlowCalculator which simulates some slow image-processing
/// operation By default, MP is not real-time. It queues all received package
/// until they are eventually processed by SlowCalculator. This is the idea at
/// least. No packages are ever lost. Since input packets arrive in real-time,
/// and their number is unlimited, it causes an ever-increased lag until the
/// program fills all RAM and crashes.
