...
public:
    ...
    Status Process(CalculatorContext* cc) override
    {
        ...
        // Note: as package are immutable, it is not allowed to paint on the
        // input image !!! Here we create a new ImageFrame by copying the one
        // from pIn, then paint on the copy
