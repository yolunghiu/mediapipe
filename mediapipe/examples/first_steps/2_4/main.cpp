/// Example 2.4 : Video pipeline with FeatureDetectorCalculator and custom image
/// processing. Here I show how to use the standard FeatureDetectorCalculator
/// (ORB keypoint detector) And how to write our own image-processing calculator
/// (draw keypoints)
...
mediapipe::Status run()
{
    ...
    // First we detect keypoints with FeatureDetectorCalculator (ORB), with up
    // to 1000 keypoints Then we draw them with our custom DrawFeatCalculator24
...
int main(int argc, char** argv)
{
    ...
    cout << "Example 2.4 : Video pipeline with FeatureDetectorCalculator and "
